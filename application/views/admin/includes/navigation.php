...
<ul class="navbar-nav mr-auto sidenav bg-white -light vh-100" id="navAccordion">
	...
	<li class="nav-item h-7 d-flex justify-content-between">
		<div class="nav-link m-auto d-flex flex-column text-center" href="#"><img class="nav-avatar img-thumbnail" src="<?php echo base_url(); ?>assets/shared/images/user.svg" alt="user"><span>Admin</span></div>
	</li>
	<ul class="shadow-sm-top pl-0 h-90">
		<div class="d-flex justify-content-between -light px-2 pt-2">
			<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="minus-circle" class="svg-inline--fa fa-minus-circle fa-w-16 rotate-90" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
			...
			<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="minus-circle" class="svg-inline--fa fa-minus-circle fa-w-16 rotate-20" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
				<path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zM124 296c-6.6 0-12-5.4-12-12v-56c0-6.6 5.4-12 12-12h264c6.6 0 12 5.4 12 12v56c0 6.6-5.4 12-12 12H124z"></path>
			</svg>
		</div>
		...
		<!-- Dashboard -->
		<li class="nav-item">
			<a class="nav-link  nav-link -collapse cv-sidenav pl-3 <?php echo ($folder_name == 'dashboard') ? 'selected' : ''; ?>" href="<?php echo base_url() . "admin/dashboard "; ?>">
		...
		<!-- Products -->
		<li class="nav-item">
			<a class="nav-link  nav-link -collapse cv-sidenav pl-3 <?php echo ($folder_name == 'products') ? 'selected' : ''; ?>" href="<?php echo base_url() . "admin/products"; ?>">
		...
		<!-- Pages -->
		<li class="nav-item">
			<a class="nav-link  nav-link -collapse cv-sidenav pl-3 <?php echo ($folder_name == 'pages') ? 'selected' : ''; ?>" href="<?php echo base_url() . "admin/pages"; ?>">
		...
		<!-- Posts -->
		<li class="nav-item">
			<a class="nav-link  nav-link -collapse cv-sidenav pl-3 <?php echo ($folder_name == 'blog') ? 'selected show' : ''; ?>" id="hasSubItems" data-toggle="collapse" data-target="#Pages" aria-expanded="false" href="/admin/pages">
		...
		<!-- Slider -->
		<li class="nav-item">
			<a class="nav-link  nav-link -collapse cv-sidenav pl-3 <?php echo ($folder_name == 'sliders') ? 'selected' : ''; ?>" id="hasSubItems" data-toggle="collapse" data-target="#slider" aria-expanded="false" href="/admin/pages">
		...
		<!-- Users -->
		<li class="nav-item">
			<a class="nav-link  nav-link -collapse cv-sidenav pl-3 <?php echo ($folder_name == 'users') ? 'selected' : ''; ?>" href="<?php echo base_url() . 'admin/manage_user/' ?>">
		...
		<!-- Products -->
		<li class="nav-item">
			<a class="nav-link  nav-link -collapse cv-sidenav pl-3 <?php echo ($folder_name == 'countries') ? 'selected' : ''; ?>" href="<?php echo base_url() . "admin/countries"; ?>">
		...
		<!-- comments -->
		<li class="nav-item">
			<a class="nav-link  nav-link -collapse cv-sidenav pl-3 <?php echo ($folder_name == 'comments') ? 'selected' : ''; ?>" id="hasSubItems" data-toggle="collapse" data-target="#comments" aria-expanded="false" href="/admin/pages">
		...
		<!-- Settings -->
		<li class="nav-item">
			<a aria-current="page" class="nav-link  nav-link -collapse cv-sidenav pl-3 <?php echo ($folder_name == 'settings') ? 'selected' : ''; ?>" id="hasSubItems" data-toggle="collapse" data-target="#Settings" aria-controls="Settings" aria-expanded="false" href="/admin/settings">
				<ion-icon name="cog" role="img" class="md hydrated" aria-label="cog"></ion-icon><span class="nav-item-text">Settings</span>
			</a>
			<ul class="nav-second-level cv-collapse collapse <?php echo ($folder_name == 'settings') ? 'show' : ''; ?>" id="Settings" data-parent="#navAccordion">
				<li class="nav-item">
				...
				<li class="nav-item"><a class="nav-link  pl-2" href="<?php echo base_url() . 'admin/email_setting/' ?>"><span class="nav-link -text p-0 ml-n3">
							<ion-icon name="radio-button-off" role="img" class="md hydrated" aria-label="radio button off"></ion-icon>Emails
						</span></a></li>
				<li class="nav-item"><a class="nav-link  pl-2" href="<?php echo base_url() . 'admin/logo_setting/' ?>"><span class="nav-link -text p-0 ml-n3">
							<ion-icon name="radio-button-off" role="img" class="md hydrated" aria-label="radio button off"></ion-icon>Media
						</span></a></li>
				<li class="nav-item"><a class="nav-link  pl-2" href="<?php echo base_url() . 'admin/footer_setting/' ?>"><span class="nav-link -text p-0 ml-n3">
							<ion-icon name="radio-button-off" role="img" class="md hydrated" aria-label="radio button off"></ion-icon>Footer
						</span></a></li>
				<li class="nav-item"><a class="nav-link  pl-2" href="<?php echo base_url() . 'admin/seo_setting/' ?>"><span class="nav-link -text p-0 ml-n3">
							<ion-icon name="radio-button-off" role="img" class="md hydrated" aria-label="radio button off"></ion-icon>SEO
						</span></a></li>
				<li class="nav-item"><a class="nav-link  pl-2" href="<?php echo base_url() . 'admin/copyright_privacy/' ?>"><span class="nav-link -text p-0 ml-n3">
		...
		<!-- Backup -->
		<li class="nav-item">
			<a class="nav-link  nav-link -collapse cv-sidenav pl-3 <?php echo ($folder_name == 'backup') ? 'selected' : ''; ?>" href="<?php echo base_url() . 'admin/backup_restore' ?>">
	...
	<li class="nav-item h-3.5">
		<div class="d-flex flex-row-reverse">
			<div class="bg-primary d-flex flex-column p-1">
				<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="minus-circle" class="svg-inline--fa fa-minus-circle fa-w-16 rotate-90 mb-3" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
					<path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zM124 296c-6.6 0-12-5.4-12-12v-56c0-6.6 5.4-12 12-12h264c6.6 0 12 5.4 12 12v56c0 6.6-5.4 12-12 12H124z"></path>
				</svg>
				<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="minus-circle" class="svg-inline--fa fa-minus-circle fa-w-16 rotate-20" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
					<path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zM124 296c-6.6 0-12-5.4-12-12v-56c0-6.6 5.4-12 12-12h264c6.6 0 12 5.4 12 12v56c0 6.6-5.4 12-12 12H124z"></path>

			...
			<ul class="d-flex">
				<li class="nav-item mx-3">
					<a class="nav-link text-white" href="#" data-toggle="tooltip" data-placement="bottom" title="visit website">
						<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="globe-africa" class="svg-inline--fa fa-globe-africa fa-w-16 admin-nav-icons" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
				...
				<li class="nav-item mx-3"><a class="nav-link text-white" href="#" data-toggle="tooltip" data-placement="bottom" title="Notifications"><span class="admin-nav-icons">
							<ion-icon name="notifications" role="img" class="md hydrated" aria-label="notifications"></ion-icon>
						</span><span class="badge badge-light mt-n2 ml-n2 position-absolute">5</span></a></li>

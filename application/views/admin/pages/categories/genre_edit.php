<?php
$categorys   = $this->db->get_where('category', array('category_id' => $param2))->result_array();
foreach ($categorys as $row) :
?>
    <?php echo form_open(base_url() . 'admin/category/update/' . $param2, array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data')); ?>

    <h4 class="text-center"><?php echo trans('category_edit'); ?></h4>
    <hr>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-12">
            <div class="profile-info-name text-center"> <img id="thumb_image" src="<?php echo $this->common_model->get_category_image_url($row['category_id']); ?>" class="img-thumbnail bg-gray-50" alt="category" width="120"> </div>
            <br>

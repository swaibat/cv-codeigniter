<div class="card">
    <div class="row">
        <div class="col-sm-12">
            <button data-toggle="modal" data-target="#mymodal" data-id="<?php echo base_url() . 'admin/view_modal/sliders/slider_add';?>" id="menu" class="btn btn-sm btn-primary waves-effect waves-light"><span class="btn-label"><i class="fa fa-plus"></i></span>Add Slider</button>
            <br>
            <br>
                        ...
                        <td>
                            <?php 
                                if($slider['action_type'] == 'product'):
                                    echo "Product: " .$this->common_model->get_title_by_product_id($slider['action_id']);
                                elseif($slider['action_type'] == 'tvseries'):
                                    echo "TVSeries: " .$this->common_model->get_title_by_product_id($slider['action_id']);

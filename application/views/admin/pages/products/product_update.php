<?php $product = $this->db->get_where('products', array('product_id' => $product_id))->row(); ?>
<div class="card border-0 shadow-xs">
	<div class="row">
		<div class="col-sm-12">
			<form action="<?= base_url() . 'admin/product_update/' . $product_id ?>" method="post">
				<div class="form-row modal-body p-4">
					<div class="col-md-9">
						<div class="cv-form-group input-group mb-3 mt-4 px-3">
							<div class="input-group-prepend"><span class="input-group-text bg-white rounded-0 cv-chev left">
								...
								</span></div><input id='title' name="title" type="text" value='<?= $product->title ?>' class="form-control custom-input" required><span class="bar"></span><label class="cv-label left text-capitalize">title</label>
						</div>
					</div>
					<div class="col-md-3">
					...
					<div class="col-md-6 d-none">
						<div class="cv-form-group input-group mb-3 mt-4 px-3">
							<div class="input-group-prepend"><span class="input-group-text bg-white rounded-0 cv-chev left">
								...
								</span></div><input id="slug" name="slug" type="text" class="form-control custom-input" required="" value="<?= $product->slug ?>"><span class="bar"></span><label class="cv-label left text-capitalize">slug</label>
						</div>
					</div>
					...
					<div class="col-md-3">
						<div class="cv-form-group input-group mb-3 mt-4 px-3">
							<div class="input-group-prepend"><span class="input-group-text bg-white rounded-0 cv-chev left">
									<ion-icon name="trail-sign-outline"></ion-icon>
								</span></div><input name="price" type="text" class="form-control custom-input" value='<?= $product->price ?>' required=""><span class="bar"></span><label class="cv-label left text-capitalize">Price</label>
						</div>
					</div>
					<div class="col-md-3">
						<div class="cv-form-group input-group mb-3 mt-4 px-3">
							<div class="input-group-prepend"><span class="input-group-text bg-white rounded-0 cv-chev left">
									<ion-icon name="trail-sign-outline"></ion-icon>
								</span></div><input name="compare_price" value='<?= $product->compare_price ?>' type="text" class="form-control custom-input" required=""><span class="bar"></span><label class="cv-label left text-capitalize">Compare to price</label>
						</div>
					</div>
					<div class="col-md-3">
						<div class="cv-form-group input-group mb-3 mt-4 px-3">
							<div class="input-group-prepend"><span class="input-group-text bg-white rounded-0 cv-chev left">
									<ion-icon name="trail-sign-outline"></ion-icon>
								</span></div><input name="available_quantity" type="text" class="form-control custom-input" value='<?= $product->available_quantity ?>' required=""><span class="bar"></span><label class="cv-label left text-capitalize">available quantity</label>
						</div>
					</div>
					<div class="col-md-3">
						<div class="cv-form-group input-group mb-3 mt-4 px-3">
					...
					<div class="col-md-12">
						<div class="cv-form-group input-group mb-3 mt-4 px-3">
							<div class="input-group-prepend"><span class="input-group-text bg-white rounded-0 cv-chev left">
								...
								</span></div><input name="focus_keyword" value='<?= $product->focus_keyword ?>' type="text" class="form-control custom-input" required=""><span class="bar"></span><label class="cv-label left text-capitalize">focus keywords separated by commas</label>
						</div>
					</div>
					<div class="col-md-12">

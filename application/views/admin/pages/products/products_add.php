    ...
    <div class="col-lg-6 offset-md-3 ">
        <div class="panel panel-border panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><?php echo trans('import_products_or_tv_show_from_tmdb'); ?></h3>
            </div>
...
<?php echo form_open(base_url() . 'admin/Products/add/', array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data')); ?>
<div class="row">
    <div class="col-md-6">

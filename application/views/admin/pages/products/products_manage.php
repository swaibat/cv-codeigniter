...
<div class="card">
	<div class="row">
		<div class="col-sm-12 mt-n3">
			<a href="<?php echo base_url() . 'admin/Products_add'; ?>" class="btn btn-sm btn-primary mb-n5"><span class="btn-label"><i class="fa fa-plus"></i></span><?php echo trans('add_page'); ?></a>

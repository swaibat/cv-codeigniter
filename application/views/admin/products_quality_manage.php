...
<div class="card">
  <div class="row">
    <div class="col-sm-6">
      <?php echo form_open(base_url() . 'admin/Product_quality/add/', array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data')); ?>
      <h4 class="text-center"><?php echo trans('add_Product_quality'); ?></h4>
      <hr>
      <div class="form-group">
        <label class="col-sm-3 control-label"><?php echo trans('Product_quality'); ?></label>
        <div class="col-sm-6">
      ...
      <?php echo form_open(base_url() . 'admin/Product_quality/add/', array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data')); ?>
      <h4 class="text-center"><?php echo trans('default_Product_quality'); ?></h4>
      <hr>
      <div class="form-group">
        <label class="control-label"><?php echo trans('default_Product_quality'); ?></label>
        <div class="col-sm-6">
    ...
    <div class="col-sm-6">
      <h4 class="text-center"><?php echo trans('Product_quality_list'); ?></h4>
      <hr>
      <table id="datatable-buttons" class="table table-striped">
        <thead>
          <tr>
            <th>#</th>
            <th><?php echo trans('Product_quality'); ?></th>

            ...
            <div class="col-md-9 col-sm-8 col-xs-12">
                <div class="page-title">
                    <h1 class="text-uppercase">
                        <?php echo trans('my_favorite_products_&amp;_Products'); ?>
                    </h1>
                </div>
            </div>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="profiles-wrap">
                    ...
                    <div class="pp-main col-md-9 col-sm-9">
                        <div class="ppm-head">
                            <div class="ppmh-title"><i class="fa fa-heart-o mr5"></i> <?php echo trans('favorite_products_&amp;_tv-series'); ?></div>
                        </div>
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="latest-product product-opt">
                                    <table class="table table-striped">
                                        <?php 
                                            foreach($fav_Products as $favorite_Products):
                                        ...
                                        <tr id="row_<?php echo $favorite_Products['wish_list_id'];?>">
                                            <td width="180" valign="top"><a href="<?php if($Products['is_tvseries'] =='1'){ echo base_url('tv-series/watch/'.$Products['slug'].'.html');}else{  echo base_url('watch/'.$Products['slug'].'.html');}?>"><img class="img-responsive" src="<?php echo $this->common_model->get_Product_thumb_url($Products['Products_id']); ?>" width="120" alt="Blade Runner 2049"></a></td>
                                            <td valign="top">
                                                <div>
                                                    <a href="<?php echo base_url('watch/'.$Products['slug'].'.html');?>"><h3><?php echo $Products['title'];?></h3></a>
                                                </div>

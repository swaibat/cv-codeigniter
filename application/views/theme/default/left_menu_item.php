...
<ul class="nav navbar-nav navbar-left">
  ...
  <?php if ($category_to_primary_menu == '1') : ?>
    <li class="dropdown">
      <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo trans('category'); ?> <span class="caret"></span></a>
      <div class="dropdown-menu row col-lg-12 three-column-navbar" role="menu">
        <?php $all_published_category = $this->category_model->all_published_category();
        foreach ($all_published_category as $category) :
        ?>
          <div class="col-md-3">
            <ul class="menu-item list-unstyled">
              <li><a href="<?php echo base_url('category/' . $category->slug . '.html'); ?>"><?php echo $category->name; ?></a></li>
            </ul>
          </div>
        <?php endforeach; ?>
      </div>

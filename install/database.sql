...
(116, 'category_to_primary_menu', '1'),
...
INSERT INTO `category` (`category_id`, `name`, `description`, `slug`, `publication`, `featured`) VALUES
...
CREATE TABLE IF NOT EXISTS `tvseries_subtitle` (
  ...
  `product_id` varchar(250) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `category` varchar(200) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,

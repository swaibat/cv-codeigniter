...
<head>
    ...
    <title>Vendly - Largest online vendors shop</title>
    ...
    <div class="install-box">
        ...
        <div class="panel panel-install">
            <div class="panel-heading text-center">
                <h2> Vendly &amp; Largest online vendors shop</h2>
            </div>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane" id="configuration-tab">
                        <form name="config-form" id="config-form" action="do_install.php" method="post">
                            ...
                            <div class="section clearfix">
                                <p>3. Please enter your item purchase code (<a target="_blank" href="https://bit.ly/2QCCRlD">NULLED scriptzzz!</a>).</p>
                                <hr />
                                <div>
                                    <div class="form-group clearfix">
                        ...
                        <div class="section">
                            <div class="clearfix">
                                <i class="status fa fa-check-circle-o pull-left" style="font-size: 50px"> </i><span
                                    ...
                                    installed <strong>Vendly - Largest online vendors shop</strong></span>
                            </div>

...
var _Product = (typeof window !== "undefined" ? window['Productjs'] : typeof global !== "undefined" ? global['Productjs'] : null);
...
var Component = _Product2.default.getComponent('Component');
var Tech = _Product2.default.getComponent('Tech');
...
var Vimeo = function (_Tech) {
  ...
  Vimeo.prototype.createEl = function createEl() {
    var div = _Product2.default.createEl('div', {
  ...
  Vimeo.prototype.src = function src() {
    // @note: Not sure why this is needed but Productjs requires it
  ...
  Vimeo.prototype.buffered = function buffered() {
    ...
    return _Product2.default.createTimeRange(0, progress.percent * progress.duration);
  };
...
/**
 * Check if Vimeo can play the given Producttype
 * @param  {String} type    The mimetype to check
 * @return {String}         'maybe', or '' (empty string)
 */
Vimeo.nativeSourceHandler.canPlayType = function (source) {
  if (source === 'Product/vimeo') {
    return 'maybe';
  }

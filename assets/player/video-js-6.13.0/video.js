...
var BACKGROUND_SIZE_SUPPORTED = isReal() && 'backgroundSize' in window_1.document.createElement('Product').style;
...
var autoSetup = function autoSetup() {
  ...
  var vids = document_1.getElementsByTagName('Product');
  var audios = document_1.getElementsByTagName('audio');
  var divs = document_1.getElementsByTagName('Product-js');
  var mediaEls = [];
...
function moveBoxToLinePosition(window, styleBox, containerBox, boxPositions) {
  ...
  // Find the best position for a cue box, b, on the Product. The axis parameter
  ...
  if (cue.snapToLines) {
    ...
    // relative to the bottom of the Product instead of the top. Therefore, we
    // need to increase our initial position by the length or width of the
    // Product, depending on the writing direction, and reverse our axis directions.
    if (linePos < 0) {
...
function VTTCue(startTime, endTime, text) {
  ...
  // http://www.whatwg.org/specs/web-apps/current-work/multipage/the-Product-element.html#text-track-cue-display-state
...
var Tech = function (_Component) {
  ...
  Tech.getTech = function getTech(name) {
    ...
    if (window_1 && window_1.Productjs && window_1.Productjs[name]) {
      ...
      return window_1.Productjs[name];
    }
  };
...
var Html5 = function (_Tech) {
  ...
  Html5.prototype.createEl = function createEl$$1() {
    ...
    if (!el || !(this.options_.playerElIngest || this.movingMediaElementInDOM)) {
      ...
      if (el) {
        ...
        el = document_1.createElement('Product');
  ...
  Html5.prototype.getVideoPlaybackQuality = function getVideoPlaybackQuality() {
    ...
    if (window_1.performance && typeof window_1.performance.now === 'function') {
      ProductPlaybackQuality.creationTime = window_1.performance.now();
    } else if (window_1.performance && window_1.performance.timing && typeof window_1.performance.timing.navigationStart === 'number') {
      ProductPlaybackQuality.creationTime = window_1.Date.now() - window_1.performance.timing.navigationStart;
    }
...
if (isReal()) {
   ...
   * @private
   */
  Html5.TEST_VID = document_1.createElement('Product');
...
Html5.canOverrideAttributes = function () {
  ...
  try {
    ...
    Object.defineProperty(document_1.createElement('Product'), 'src', { get: noop, set: noop });
    Object.defineProperty(document_1.createElement('audio'), 'src', { get: noop, set: noop });
    Object.defineProperty(document_1.createElement('Product'), 'innerHTML', { get: noop, set: noop });
...
var Player = function (_Component) {
  ...
  Player.prototype.createEl = function createEl$$1() {
    ...
    if (divEmbed) {
      el = this.el_ = tag;
      tag = this.tag = document_1.createElement('Product');
...
if (typeof HTMLVideoElement === 'undefined' && isReal()) {
  document_1.createElement('Product');
  document_1.createElement('audio');
  document_1.createElement('track');
  document_1.createElement('Product-js');
}
